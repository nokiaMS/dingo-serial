...
void DingoSchema<std::optional<int64_t>>::InternalEncodeKey(Buf* buf,
                                                            int64_t data) {
  if (buf->IsLe()) {
...
void DingoSchema<std::optional<int64_t>>::LeInternalEncodeKey(Buf* buf,
                                                              int64_t data) {
...
void DingoSchema<std::optional<int64_t>>::BeInternalEncodeKey(Buf* buf,
                                                              int64_t data) {
  uint64_t* l = (uint64_t*)&data;
  buf->Write(*l ^ 0x80);
  buf->Write(*l >> 8);
...
void DingoSchema<std::optional<int64_t>>::LeInternalEncodeValue(Buf* buf,
                                                                int64_t data) {
  uint64_t* l = (uint64_t*)&data;
  buf->Write(*l >> 56);
  buf->Write(*l >> 48);
...
void DingoSchema<std::optional<int64_t>>::BeInternalEncodeValue(Buf* buf,
                                                                int64_t data) {
  uint64_t* l = (uint64_t*)&data;
  buf->Write(*l);
  buf->Write(*l >> 8);
...
void DingoSchema<std::optional<int64_t>>::EncodeKey(
    Buf* buf, std::optional<int64_t> data) {
  if (this->allow_null_) {
...
void DingoSchema<std::optional<int64_t>>::EncodeKeyPrefix(
    Buf* buf, std::optional<int64_t> data) {
  EncodeKey(buf, data);
}
...
std::optional<int64_t> DingoSchema<std::optional<int64_t>>::DecodeKey(
    Buf* buf) {
  if (this->allow_null_) {
...
void DingoSchema<std::optional<int64_t>>::EncodeValue(
    Buf* buf, std::optional<int64_t> data) {
  if (this->allow_null_) {
    buf->EnsureRemainder(GetWithNullTagLength());
    if (data.has_value()) {
...
std::optional<int64_t> DingoSchema<std::optional<int64_t>>::DecodeValue(
    Buf* buf) {
  if (this->allow_null_) {
    if (buf->Read() == this->k_null) {
      buf->Skip(GetDataLength());
