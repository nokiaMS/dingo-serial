...
#include "record_encoder_wrapper.h"

#include <vector>

#include "serial/record/record_encoder.h"
#include "serial/recordV2/common.h"
...
RecordEncoder::RecordEncoder(
    ...
    long common_id) {
  this->codec_version_ = V2::CODEC_VERSION_V1;
...
RecordEncoder::RecordEncoder(int schema_version,
                             ...
                             long common_id) {
  this->codec_version_ = V2::CODEC_VERSION_V2;
  this->schemas_v1_ = ConvertSchemas2V1(schemas);
  this->re_v1_ = new RecordEncoderV1(schema_version, schemas_v1_, common_id);
  this->re_v2_ = new V2::RecordEncoderV2(schema_version, schemas, common_id);
}
RecordEncoder::RecordEncoder(int schema_version,
                             const std::vector<V2::BaseSchemaPtr>& schemas,
                             long common_id, bool le) {
  ...
  this->re_v2_ = new V2::RecordEncoderV2(schema_version, schemas, common_id, le);
}
